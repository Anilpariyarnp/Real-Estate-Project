...
if(isset($_POST['h_search'])){
  ...
  //  $h_max = filter_var($h_max, FILTER_SANITIZE_STRING);
   ...
   $select_properties = $conn->prepare("SELECT * FROM `property` WHERE address LIKE '%{$h_location}%' ORDER BY date DESC");
  ...
  //  $furnished = filter_var($furnished, FILTER_SANITIZE_STRING);
   ...
   $select_properties = $conn->prepare("SELECT * FROM `property` WHERE address LIKE '%{$location}%'  ORDER BY date DESC");
   $select_properties->execute();
      ...
      <form action="" method="POST">
         ...
         <div class="box">
            ...
            <div class="flex-btn">
               ...
               <a href="contact.php?property_id=<?= $fetch_property['id']; ?>" class="btn">Send Inquiry</a>
