...
<?php
if($user_id != ''){
   // Fetch recommended properties for logged-in users
   $recommended_properties = getRecommendations($conn, $user_id);
...
<?php
      ...
      echo '<p class="empty">no recommendations found based on your activity!</p>';
   }
}
?>

<!-- recommended properties section ends -->
      ...
      <form action="" method="POST">
         ...
         <div class="box">
            ...
            <div class="flex-btn">
               ...
               <a href="contact.php?property=<?= $fetch_property['id']; ?>" class="btn">send Inquiry</a>
            </div>
         </div>
      </form>
      <?php
